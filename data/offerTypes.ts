...
export const offerTypeGuides: GuideItem[] = [
  {
    ...
    offerType: "stay",
    title: "숙소 할인코드 쓰는 순서",
    body: "숙소 코드는 검색 결과가 아니라 결제 단계에서 입력하는 경우가 많습니다. 아고다·호텔스닷컴·부킹닷컴·Nol처럼 플랫폼이 달라도 코드는 그 사이트에서만 됩니다. 특가·핫딜·시크릿가는 코드가 막힐 수 있으니, 일반 요금에 코드를 넣은 금액과 특가를 한 번 비교하세요. 결제 통화는 가능하면 KRW로 맞추면 카드 이중환전을 줄일 수 있습니다.",
  },
  {
    id: "guide-offer-tour",
    offerType: "tour",
    title: "투어·입장권 코드가 거절될 때",
    body: "클룩·마이리얼트립·Nol 레저 코드는 숙소나 항공에는 적용되지 않습니다. 테마파크 입장권, 유심, 가이드 투어처럼 카테고리가 다른 상품을 한 장바구니에 넣으면 일부만 할인되는 경우가 있습니다. 막히면 상품을 나눠 결제하거나, 코드 설명에 적힌 지역·카테고리만 남기고 다시 넣어 보세요.",
  },
  {
    ...
    stay: [
      {
        ...
        answer: `${period} ${label}는 코드세이아 ${name} 페이지에 모아 두었습니다. 아고다·호텔스닷컴·부킹닷컴·Nol·여기어때처럼 사이트마다 코드가 다릅니다. 카드에 적힌 플랫폼 결제창에만 붙여넣으세요.`,
      },
      {
        id: `faq-${slug}-input`,
    ...
    tour: [
      {
        ...
        answer: `${period} ${label}는 코드세이아 ${name} 페이지에서 복사할 수 있습니다. 클룩·마이리얼트립·Nol 레저처럼 사이트마다 코드가 다르고, ${tourNoun} 전용인 경우가 많습니다.`,
      },
      {
        id: `faq-${slug}-stay`,
