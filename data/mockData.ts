...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    platform: "호텔스닷컴",
    question: "호텔스닷컴 할인코드가 적용되지 않을 때는?",
    answer:
  ...
  },
  {
    ...
    platform: "호텔스닷컴",
    question: "원키 리워드와 할인코드를 같이 쓸 수 있나요?",
    answer:
  ...
  },
  {
    ...
    platform: "호텔스닷컴",
    question: "호텔스닷컴 예약 취소 시 쿠폰이 돌아오나요?",
    answer:
  ...
  },
  {
    id: "faq-trip-where",
    platform: "트립닷컴",
    question: "트립닷컴 프로모션 코드 입력란을 못 찾을 때는?",
    answer:
  ...
  },
  {
    ...
    platform: "트립닷컴",
    question: "트립닷컴 항공권 코드와 숙소 코드를 같이 쓸 수 있나요?",
    answer:
  ...
  },
  {
    id: "faq-trip-refund",
    platform: "트립닷컴",
    question: "트립닷컴에서 취소하면 프로모션 코드가 재발급되나요?",
    answer:
  ...
  },
  {
    id: "faq-mrt-type",
    platform: "마이리얼트립",
    question: "마이리얼트립 투어 코드가 숙소에 안 될 때는?",
    answer:
      "마이리얼트립은 웰컴 쿠폰, 투어·티켓 코드, 숙소 코드가 분리되어 있습니다. 투어 전용 코드를 숙소 결제창에 넣으면 거절됩니다. 상품 유형을 먼저 보고, 앱/웹 결제 화면의 할인코드 칸에 붙여넣으세요. 1인 1회 제한 코드는 같은 계정으로 예약한 이력이 있으면 막힙니다. 제주·부산 액티비티는 최소 결제 금액 조건이 있는 경우가 있습니다.",
  },
  {
    id: "faq-mrt-welcome",
    platform: "마이리얼트립",
    question: "마이리얼트립 웰컴 쿠폰과 할인코드를 같이 쓸 수 있나요?",
    answer:
      "신규 회원 웰컴 쿠폰과 별도 할인코드는 한쪽만 되는 결제가 많습니다. 결제창에서 웰컴 쿠폰을 적용한 금액과, 웰컴을 끄고 할인코드만 넣은 금액을 비교하세요. 카드·페이 즉시할인은 웰컴 쿠폰 뒤에도 붙는 달이 있으니, 쿠폰끼리 중복이 안 되더라도 결제 수단 할인은 따로 확인하면 됩니다.",
  },
  {
    id: "faq-mrt-refund",
    platform: "마이리얼트립",
    question: "마이리얼트립 예약 취소 후 쿠폰이 재발급되나요?",
    answer:
      "웰컴 쿠폰과 1인 1회 코드는 취소해도 다시 지급되지 않는 경우가 많습니다. 투어는 이용일 임박 취소 시 수수료와 함께 쿠폰도 소멸됩니다. 일정 변경 가능성이 있으면 취소 가능 상품을 고르고, 사용한 코드와 예약번호를 남겨 두세요. 재발급은 마이리얼트립 고객센터에 예약번호와 코드명을 함께 문의해야 합니다.",
  },
  {
    id: "faq-agoda-secret",
    platform: "아고다",
    question: "아고다 시크릿 특가에서 할인코드가 안 될 때는?",
    answer:
  ...
  },
  {
    ...
    platform: "아고다",
    question: "아고다 결제 통화를 KRW로 바꿔야 하나요?",
    answer:
  ...
  },
  {
    id: "faq-agoda-refund",
    platform: "아고다",
    question: "아고다 예약 취소 시 할인코드가 재발급되나요?",
    answer:
  ...
  },
  {
    ...
    platform: "클룩",
    question: "클룩 할인코드가 특정 상품에서만 될 때는?",
    answer:
      "클룩 코드는 테마파크, 유심, 투어처럼 카테고리가 다르면 거절됩니다. 아시아 입장권 전용 코드는 유럽 투어에 적용되지 않습니다. 장바구니에 여러 상품이 있으면 대상 상품에만 할인이 붙고 나머지는 원가입니다. 결제 페이지 상단 프로모션 코드 칸에 넣고, 최종 금액이 바뀌었는지 확인하세요. 안 되면 전용 링크로 상품 페이지에 다시 들어간 뒤 같은 계정으로 결제해 보세요.",
  },
  {
    id: "faq-klook-cart",
    platform: "클룩",
    question: "클룩 코드를 장바구니와 결제 중 어디에 넣나요?",
    answer:
      "장바구니와 결제 페이지 상단 모두에 입력란이 있을 수 있습니다. 장바구니에서 거절돼도 결제 단계에서 한 번 더 되는 코드가 있고, 반대인 코드도 있습니다. 앱 전용 코드는 웹 장바구니에 넣어도 막힐 수 있으니 클룩 앱으로 이동하세요. 적용 후에는 상품별 할인 내역이 맞는지 줄을 확인해 보세요.",
  },
  {
    id: "faq-klook-refund",
    platform: "클룩",
    question: "클룩 취소 후 프로모션 코드가 재발급되나요?",
    answer:
      "대부분 재발급되지 않습니다. 날짜 지정 입장권은 취소 가능 여부와 별개로 코드가 소멸되는 경우가 많고, 유효기간이 지난 코드는 복구되지 않습니다. 일정 변경이 예상되면 날짜 변경 가능 상품을 고르고, 사용한 코드와 주문번호를 남겨 두세요. 재발급은 클룩 고객센터에 주문번호와 코드명을 함께 문의해야 합니다.",
  },
  {
    id: "faq-nol-hotdeal",
    platform: "Nol",
    question: "Nol 핫딜 숙소에서 할인코드가 거절될 때는?",
    answer:
      "이미 큰 폭으로 깎인 핫딜·타임세일 객실은 코드 제외 대상인 경우가 많습니다. 같은 숙소의 일반 요금에 코드를 넣었을 때와 핫딜가를 비교하세요. 코드는 결제 화면 쿠폰 적용 → 코드 직접 입력으로 넣습니다. 주중용 코드를 주말 예약에 넣어도 막히고, 레저 티켓 쿠폰은 숙소에 적용되지 않습니다.",
  },
  {
    id: "faq-nol-leisure",
    platform: "Nol",
    question: "Nol 레저 티켓 쿠폰을 숙소에 쓸 수 있나요?",
    answer:
      "레저 티켓과 숙소 쿠폰은 분리되어 있습니다. 숙소 결제창에 레저 코드를 넣으면 거절됩니다. 모텔·호텔·펜션은 숙소 코드만, 레저는 레저 전용 코드만 됩니다. 결제 수단 할인(카드, 페이)은 코드 적용 이후 단계에서 한 번 더 선택할 수 있으니, 쿠폰이 막혀도 카드·페이 할인은 따로 확인하세요.",
  },
  {
    id: "faq-nol-refund",
    platform: "Nol",
    question: "Nol 예약 취소 시 할인코드가 재발급되나요?",
    answer:
