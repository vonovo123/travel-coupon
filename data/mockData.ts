...
export const platformGuides: GuideItem[] = [
  ...
  },
  {
    ...
    body: "클룩(Klook) 할인코드는 장바구니 또는 결제 페이지 상단의 프로모션 코드 입력란에 넣습니다. 테마파크 입장권, 유심, 투어처럼 상품 카테고리가 다른 경우 코드가 막힐 수 있습니다. 아시아 투어·입장권 전용 코드는 유럽 상품에는 적용되지 않습니다. 결제 전 최종 금액이 바뀌었는지 확인하고, 적용이 안 되면 전용 링크를 통해 상품 페이지에 다시 접속한 뒤 같은 계정으로 결제해 보세요. 특가·번들 상품은 결제 후 취소가 안 되는 경우가 있으니, 코드 적용 전에 상품 상세의 취소 규정도 같이 보세요.",
  },
  {
    id: "guide-klook-refund",
    platform: "클룩",
    title: "클룩 예약 취소·환불 전에 확인할 것",
    body: "클룩 환불은 사이트 공통 규정이 아니라 예약한 그 상품의 취소 정책을 따릅니다. 무료 취소 마감 시간, 부분 환불 비율, 환불 불가는 상품 상세와 바우처에 적혀 있습니다. 앱이나 웹의 예약 내역에서 직접 취소가 열리는 상품이 있고, 조건부·환불 불가 상품은 고객센터 문의만 가능한 경우가 있습니다. 할인코드를 쓴 예약도 취소 가능 여부는 요금제가 아니라 상품 정책을 기준으로 봅니다. 일정 변경이 예상되면 결제 전에 마감 시간을 저장해 두는 편이 안전합니다.",
  },
  {
    id: "guide-klook-card",
    platform: "클룩",
    title: "클룩 제휴카드·할인코드 같이 쓰는 법",
    body: "클룩 제휴카드 즉시할인·캐시백은 할인코드와 겹치는 달이 많습니다. 결제창에서는 프로모션 코드를 먼저 넣고, 그다음 결제 수단에서 제휴카드나 페이를 고른 뒤 최종 차감액을 확인하세요. 일부 카드 혜택은 USD 결제에만 열려 있어서, 화면이 KRW로 고정돼 있으면 통화를 달러로 바꾼 뒤에야 할인이 붙습니다. 반대로 일반 카드로 KRW를 고르면 DCC 수수료가 생길 수 있어, 간편결제(원화) 또는 해외 수수료 면제 카드+USD 조합과 최종가를 비교하는 편이 낫습니다. 특가·최대 할인 상품은 코드와 카드가 동시에 안 될 수 있습니다.",
  },
  {
    id: "guide-hotels",
    platform: "호텔스닷컴",
...
export const paymentTips: PaymentTip[] = [
  ...
  },
  {
    ...
    body: "클룩은 테마파크·유심·투어마다 카드 즉시할인 대상이 다릅니다. 입장권 전용 카드 이벤트를 유심 결제에 쓰면 할인이 빠집니다. 신한·삼성·KB·IBK 등 월별 클룩 제휴 할인이 있어도, 이미 큰 폭으로 깎인 번들·특가는 제외될 수 있습니다. 코드 적용 후 카드 선택 화면에서 예상 할인액이 0원이면 그 상품은 카드 이벤트 대상이 아닙니다. 최소 결제 금액 조건이 있는 코드를 쓸 때는 카드 할인 전 금액 기준으로 통과 여부를 보세요. 제휴 조건은 달마다 바뀌니 결제 직전 클룩 이벤트 배너와 카드사 안내를 같이 확인하세요.",
  },
  {
    id: "pay-klook",
    platform: "클룩",
    title: "클룩 네이버페이·카카오페이·DCC 수수료",
    body: "클룩은 해외 가맹점이라 일반 카드로 원화(KRW) 결제를 고르면 DCC(이중 환전) 수수료가 붙을 수 있습니다. 수수료를 피하려면 네이버페이·카카오페이·토스페이처럼 원화 간편결제를 쓰거나, 통화를 USD로 맞춘 뒤 해외 수수료가 없는 카드로 달러 결제하는 편이 안전합니다. 할인코드 → 페이 또는 제휴카드 선택 → 최종 금액 확인 순서로 적용하세요. 장바구니에 서로 다른 카테고리 상품이 섞여 있으면 페이 쿠폰이 일부만 붙을 수 있습니다. 카드사 앱에서 해외 원화 결제 차단을 켜 두면 실수로 KRW 결제가 되는 일을 줄일 수 있습니다.",
  },
  {
    id: "card-nol",
    platform: "Nol",
...
export const faqs: FaqItem[] = [
  ...
  {
    id: "faq-klook-cancel-policy",
    platform: "클룩",
    question: "클룩 예약은 언제든 취소·환불되나요?",
    answer:
      "아닙니다. 취소 가능 여부는 클룩 전체가 아니라 예약한 상품 상세·바우처 규정에 따릅니다. 이용일 기준 일정 시간 전까지 전액 환불되는 무료 취소, 취소 시점에 따라 수수료가 붙는 부분 환불, 결제 후 돌려받을 수 없는 환불 불가 상품이 섞여 있습니다. 특가·콤보 티켓은 환불 불가인 경우가 많아, 할인코드를 넣기 전에 취소 문구를 먼저 확인하세요.",
  },
  {
    id: "faq-klook-how-to-cancel",
    platform: "클룩",
    question: "클룩 예약 취소는 앱에서 어떻게 하나요?",
    answer:
      "클룩 앱 또는 웹에 로그인한 뒤 예약 내역에서 해당 건을 열고, 예약 관리·환불 신청이 보이면 사유와 수량을 고른 다음 환불 예정 금액을 확인한 뒤 완료합니다. 취소가 끝나면 기존 바우처는 쓸 수 없습니다.\n\n직접 취소 버튼이 없거나 조건부 규정이면 바우처의 취소 조건을 충족하는지 본 뒤 클룩 고객센터에 문의하세요. 환불 불가 상품은 결제 후에는 돌려받기 어렵습니다.",
  },
  {
    id: "faq-klook-refund-time",
    platform: "클룩",
    question: "클룩 환불은 얼마나 걸리나요?",
    answer:
      "취소가 승인되면 보통 하루 안에 환불 절차가 시작되지만, 돈이 카드·계좌에 찍히는 시점은 결제 수단마다 다릅니다. 신용·체크카드와 애플페이·구글페이는 영업일 기준 일주일에서 이 주 안팎, 클룩 크레딧·포인트로 돌려받는 경우는 승인 후 바로 복원되는 편입니다. 현지 월렛·계좌이체는 더 오래 걸릴 수 있고, 원래 결제 수단으로 돌려주기 어려우면 계좌 이체로 바뀌면서 한 달 가까이 걸리기도 합니다. 일정이 지나도 입금이 없으면 예약번호와 함께 클룩 고객센터에 문의하세요.",
  },
  {
    id: "faq-klook-change",
    platform: "클룩",
    question: "클룩에서 날짜나 인원을 바꿀 수 있나요?",
    answer:
      "상품에 따라 다릅니다. 변경이 허용된 예약은 예약 내역에서 해당 건을 연 뒤 예약 변경으로 날짜·탑승객·요청사항을 고칠 수 있고, 확정되면 새 바우처가 옵니다. 변경 메뉴가 없거나 거절되면 그 상품은 일정 수정이 안 되는 요금입니다. 채팅 상담이 필요하면 같은 예약 화면에서 고객센터로 이어지면 됩니다.",
  },
  {
    id: "faq-klook-weather",
    platform: "클룩",
    question: "날씨나 운영 취소로 투어가 무산되면 환불되나요?",
    answer:
      "운영 측 사정으로 액티비티가 취소되면 클룩 고객센터를 통해 처리를 요청하는 경우가 많습니다. 문의할 때 예약자 성명, 예약번호, 상품명, 운영사 공지나 현장 사진을 같이 보내면 확인이 빨라집니다. 최종 환불·일정 변경 여부는 해당 상품 규정과 운영사 안내를 따릅니다.",
  },
  {
    id: "faq-klook-noshow",
    platform: "클룩",
    question: "클룩 투어에 늦거나 안 가면 돈을 돌려받나요?",
    answer:
      "날짜가 고정된 티켓은 사전 연락 없이 불참하면 환불이 어려운 경우가 대부분입니다. 날짜를 나중에 고를 수 있는 오픈 티켓은 바우처에 적힌 유효 기간 안에 다른 날로 쓰는 편이 가능합니다. 질병, 항공편 취소처럼 피할 수 없는 사정이면 가능한 한 빨리 운영사 또는 클룩 고객센터에 증빙과 함께 알려 보세요. 받아 줄지는 상품·운영사마다 다릅니다.",
  },
  {
    id: "faq-klook-flight",
    platform: "클룩",
    question: "항공편이 지연·취소돼도 클룩 예약을 취소할 수 있나요?",
    answer:
      "먼저 그 상품이 무료 취소 대상인지 바우처를 확인하세요. 무료 취소 기간이면 예약 내역에서 직접 취소하면 됩니다. 기간이 지났거나 환불 불가 상품이면 성명, 예약번호, 상품명, 항공편 취소 안내문을 준비해 클룩 고객센터에 문의하세요. 받아 줄지는 보장되지 않습니다.",
  },
  {
    id: "faq-klook-cs",
    platform: "클룩",
    question: "클룩 고객센터는 어디서 채팅하나요?",
    answer:
      "클룩 앱·웹에서 프로필의 예약 목록으로 들어가 해당 예약을 연 다음, 이 예약에 도움이 필요하신가요 영역의 채팅하기를 누르면 됩니다. 이름, 예약 참조 번호, 상품명, 원하는 처리를 같이 적으면 안내가 빨라집니다.\n\n환불 불가 요금이어도 사정을 설명하면 포인트 일부 보상 논의를 하는 사례가 있다는 후기는 있습니다. 규정상 의무는 아니니, 기대를 낮추고 문의하는 정도로 보는 편이 맞습니다.",
  },
  {
    id: "faq-klook-card-stack",
    platform: "클룩",
    question: "클룩 할인코드랑 제휴카드 할인을 같이 쓸 수 있나요?",
    answer:
      "되는 달이 많습니다. 결제창에서 할인코드를 먼저 적용한 뒤, 결제 수단으로 제휴카드나 페이를 고르면 즉시할인이 한 겹 더 붙는지 최종 금액으로 확인하세요. 이미 크게 깎인 특가·번들은 코드와 카드가 동시에 거절될 수 있습니다. 제휴 카드·한도·대상 상품은 매월 바뀌므로 클룩 이벤트 배너와 카드사 공지를 결제 직전에 보는 편이 안전합니다.",
  },
  {
    id: "faq-klook-usd-card",
    platform: "클룩",
    question: "클룩 제휴카드 할인이 안 붙으면 왜인가요?",
    answer:
      "일부 제휴 혜택은 USD 결제에만 열립니다. 앱·웹 통화가 KRW로 잡혀 있으면 달러로 바꾼 뒤 같은 카드를 다시 골라 보세요. 카드 브랜드(비자·마스터)나 상품 카테고리(숙소·투어·유럽)가 이벤트 조건과 달라도 할인이 빠집니다. 예상 할인액이 0원이면 그 예약은 대상이 아닙니다.",
  },
  {
    id: "faq-klook-dcc",
    platform: "클룩",
    question: "클룩을 원화로 결제하면 수수료가 붙나요?",
    answer:
      "클룩은 해외 가맹점이라 일반 신용·체크카드로 원화(KRW) 결제를 고르면 DCC(이중 환전) 수수료가 붙는 경우가 있습니다. 달러(USD)로 결제하면 브랜드 해외 수수료가 남을 수 있고, 해외 수수료가 없는 카드와 USD를 맞추면 이 부담을 줄일 수 있습니다. 네이버페이·카카오페이·토스페이는 원화로 결제되면서 DCC를 피하는 편입니다. 카드사 앱에서 해외 원화 결제 차단을 켜 두면 KRW로 잘못 결제되는 일을 막을 수 있습니다.",
  },
  {
    id: "faq-nol-hotdeal",
    platform: "Nol",
